...
$update_terbaru  = $data6['update_terbaru'];
        ...
        <div class="container">
          ...
          <div class="row row-cols-2">
            ...
            <div class="col-4 campaign" style="">
              ...
              <?php
                if ($data['periode'] < date('Y-m-d')) { ?>

               <div class="donasi">
                <a href="https://dompetdonasi.com/campaign/donasi/donasi?id=<?php echo $data["link"]; ?>" class="btn-lg btn-lg disabled btn btn-donasi-sekarang ">DONASIKAN</a>
              </div>
              <?php }else{ ?>
                <div class="donasi">
                    <a href="https://dompetdonasi.com/campaign/donasi/donasi?id=<?php echo $data["link"]; ?>" class="btn btn-donasi-sekarang ">DONASIKAN</a>
                  </div>
              <?php } ?>
              ...
              <div class="user">
                <div class="row">
                  <div class="col-3">
                    <div class="lingkaran">
                      <img src="../img/user_account/profile_default.png" style="width: 70px; height: 70px;" >
                    </div>
                  </div>
                  <div class="col-9">
                    ...
                    <div class="row row-cols-2">
                      <div class="col-2">
                        <div class="orang-donasi" style="">
                          <img src="../img/user_account/profile_default.png" style="width: 50px; height: 50px;" >
                        </div>
                      </div>
                      <div class="col-10" class="data-donasi">
                        <p class="donasi-donatur">Donasi <b style="font-weight: bold; color: #55A746;"><?php echo number_format($data3["jumlah_donasi"]); ?></b></p>
    ...
    <div class="hp">
      ...
      <div class="halsatu-hp shadow-sm">
        ...
        <div class="container">
          ...
          <div class="donasi-hp">
            <a href="https://dompetdonasi.com/campaign/donasi/donasi?id=<?php echo $data["link"]; ?>" class="btn btn-donasi-sekarang-hp">DONASI SEKARANG</a>
          </div>
        </div>
      </div>
      <div class="haldua-hp shadow-sm">
        <div class="container">
          <p class="text-header-penggalangan-dana-hp">Informasi Penggalangan Dana</p>
            <div class="penggalang-dana" style=" border-radius:10px;">
              <div class="row row-cols-2">
                <div class="col-2 icon-user-hp" style="margin-right: 10px;">
                   <p style="center"><i class="far fa-user" style="color:#847d84; margin-top:12px;font-size:22px; margin-left:16px;"></i></p>
                </div>
      ...
      <div class="haltiga-hp shadow-sm">
        <div class="container">
          <p class="text-header-penggalangan-dana-hp">Cerita</p>
            <div class="card cerita shadow sm" style="border:none; padding:15px; border-radius:10px; margin-bottom:20px;">
                <div class="container">
                    ...
                    <div class="share-hp">
                      <div class="container">
                        <div class="row row-cols-3">
                          ...
                          <div class="col-2">
                            <p style="text-align:center"><a class="btn btn-whatsapp-bottom" href="whatsapp://send?text=https://dompetdonasi.com/campaign/campaign?id=<?php echo $data["link"]; ?>" data-action="share/whatsapp/share"  
        target="_blank"><i class="fab fa-whatsapp"></i></a></p>
                          </div>
                          <div class="col-8">
