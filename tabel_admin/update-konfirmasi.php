                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <a class="dropdown-item text-danger" href="../admin/logout"><i class="bx bx-power-off font-size-17 align-middle mr-1 text-danger"></i> Logout</a>
                            </div>
                        </div>
            ...
            <!-- Left Sidebar End -->
             ...
             <div class="main-content">
                        ...
                        <?php
                            ...
                            $id = $_GET['id'];
                            $query = mysqli_query($koneksi, "SELECT * FROM campaign where id = '$id'");
                                                ...
                                                <form class="outer-repeater" method="POST">
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea id="formmessage" name="deskripsi"  class="form-control" rows="3" ><?php echo htmlspecialchars_decode( $hasil['deskripsi']);?></textarea>
                                                        </div>
                                                    <div>
                                                 <input type="submit" name="kirim" class="btn btn-primary" value="Konfimasi Campaign">
                                             </div> 
                                         </form>
                                     </div>
                                 </div>
                    ...
                    <?php
                        ...
                        if (isset($_POST['kirim'] )) {
                            ...
                            $id = $_GET['id'];
                            $query =  "UPDATE `campaign` SET `konfirmasi` = 'OK'  WHERE id = '$id'";

                          if (mysqli_query($conn, $query)) {  
                                echo "<script>
                                        alert('Data Berhasil di Konfirmasi'); document.location.href = 'konfirmasi-campaign';
                                    </script>";
                            } else {
