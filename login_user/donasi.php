...
if (isset($_POST["transfer"]) ) {
      ...
      if(donasi($_POST) > 0 ) {
        echo "<script>
                ...
                document.location.href = 'bank_user/bri';
            </script>";
  ...
  if (isset($_POST["transfer2"]) ) {
      ...
      if(donasi2($_POST) > 0 ) {
        echo "<script>
                alert('Harap di transfer dalam waktu 24jam');
                document.location.href = 'bank_user/bni';
            </script>";
                ...
                <form class="d-flex">
                  ...
                  <div class="dropdown">
                        ...
                        <div class="row row-cols-2">
                          <div class="col">
                            <div class="user-header">
                              <img src="https://dompetdonasi.com/img/user_account/<?php echo $_SESSION['profil']; ?>" width="100%" style="border-radius: 20px;">
                            </div>
                          </div>
                        </div>
                      </div></button>
                    <div class="dropdown-content">
                      ...
                      <a href="#" class="nav-user"><i class="fa fa-sign-out" aria-hidden="true" width="100%"></i>Logout</a>
                    </div>
                  </div> 
                </form>
              </div>
                ...
                <div class="accordion" id="accordionExample2">
                  <div class="accordion-item">
                    <h2 class="accordion-header" id="headingThree">
                      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="true" aria-controls="collapseOne"><img src="../img/icon/bri.png" style="width:35%; margin-right:10px;">
                        Bank BRI
                      </button>
                    </h2>
                  ...
                  <div class="accordion-item">
                    <h2 class="accordion-header" id="headingFour">
                      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseTwo"><img src="../img/icon/bni.png" style="width:28%; margin-right:10px;">
                        Bank BNI
                      </button>
                    </h2>
