...
<head>
  <meta charset="utf-8">
    ...
    <title>Dompet Donasi - Semua Campaign</title>
</head>
      ...
      <div class="footer-hp">
        <div class="footer-fix-hp fixed-bottom">
              <div class="row row-cols-4">
                ...
                <div class="col-3">
                    <p class="text-footer-fixed-hp"><a href="#" class="link-text-footer" style="color:#35a04c;"><i class="fas fa-hand-holding-heart"style="color:#35a04c;"></i><br>Donasi</a></p>
                </div>
                <div class="col-3">
