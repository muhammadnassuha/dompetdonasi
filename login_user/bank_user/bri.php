...
<head>
  ...
  <title>Dompet Donasi - Donasi Sekarang</title>
  ...
  <body>
      ...
      <div class="container"  class="shadow-sm" style="padding: 10px;margin-top: 40px;">
        ...
        <div class="konfirmasi shadow-sm" style="background-color: white; padding: 30px; border-radius: 10px;">
          ...
          <p  style="text-align: center;">Segera lakukan pembayaran dengan nominal :</p>

          <h5 class="donasi" style="text-align: center;">Rp. <?php echo $hasil; ?><font class="unik"><?php echo $kd_unik; ?></h5></font>

          <table class="table">
            <tr>
              <td style="text-align: left;">Jumlah Donasi </td>
              <th style="text-align: right;"><?php echo $row["donasi"]; ?></th>
            </tr>

            <tr>
              <td style="text-align: left;">Kode Unik <font color="#FFA07A">*</font></td>
              <th style="text-align: right;"><?php echo $kd_unik; ?></th>
            </tr>
          </table>
          ...
          <div class="title_donasi"  style="text-align: center;">Harap ditransfer Ke Rek a/n <b><?php echo $row["nama_rek"]; ?></b> berikut ini :</div>
            <div class="rekening" style="text-align: center; margin-top: 15px">
              <img src="../../img/bank/bri.png" style="float: bottom; width: 6em;"><p class="no_rek" style="font-size: 18px;"><b><?php echo $row["no_rek"]; ?></b></p>
            </div>
            <p  style="text-align: center;">Segera lakukan pembayaran sebelum tanggal <br><b><?php echo $tgl; ?> Pukul <?php echo $waktu; ?> WIB</b></p>
          </div>
