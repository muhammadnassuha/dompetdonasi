      ...
      <div class="desktop">
        ...
        <!-- Start Header -->
          ...
          <section class="p-4 my-container active-cont">
              ...
              <h1 style="font-weight: bold;">Campaign Saya</h1>
                <!-- Hal2 -->
                  <div class="hal2">
                      ...
                      <div class="data-profil">
                        ...
                        <div class="row row-cols-3">
                          ...
                          <div class="col"  style="width: 18em;">
                            <a href="https://dompetdonasi.com/login_user/dashboard/campaign/?id=<?php echo $data["link"]; ?>" class="campaign" style="text-decoration: none;">
                  ...
                  <div class="hal2">
                    <div class="container"style="display: inline-block;">
                      <div class="data-profil">
                        <div class="row row-cols-2">
                          <div class="col-8">
                            <p class="text-campaign-donasi">Campaign kamu</p>
                            <hr>
                          </div>
                        </div>
                        <!-- card Campaign -->
                        <div class="row row-cols-3">
                          ...
                          <div class="col"  style="width: 18em;">
                            <a href="https://dompetdonasi.com/login_user/dashboard/campaign/?id=<?php echo $data3["link"]; ?>" class="campaign" style="text-decoration: none;">
                              <div class="card campaign">
