...
if (isset($_POST["update"]) ) {
      ...
      if(edit_campaign($_POST) == 1 ) {
        echo "<script>
                alert('Campaign Selesai Diedit');
...
$awal  = new DateTime($data['periode']);
$akhir = new DateTime(); // Waktu sekarang
$diff  = $awal->diff($akhir);


// die(var_dump($diff->days));
              ...
              <div class="hal2">
                <div class="container"style="display: inline-block; padding-left: 10em;">
                  <div class="data-profil">
                    <div class="row row-cols-2">
                      <div class="col-8">
                        <p class="text-campaign-donasi">Edit Campaign</p>
                        <hr>
                      </div>
                    </div>
                    <form method="post" enctype="multipart/form-data" action="" id="postForm" onsubmit="return validasi_input(this)">
                      <div class="form-group" style="margin-bottom:10px;">
                        <input type="text" class="form-control" name="judul" value="<?php echo $data["judul"]; ?>" disabled style="cursor: not-allowed;">
                      ...
                      <div class="input-group" style="margin-bottom:10px;">
                        <div class="input-group-text" id="basic-addon3" disabled style="cursor: not-allowed;">dompetyatimamanah.com/</div>
                        <input type="text" class="form-control" name="link_donasi" id="tanpaspasi" value="<?php echo $data["link"]; ?>" disabled style="cursor: not-allowed;">
                      </div>

                      <div class="input-group" style="margin-bottom: 20px;">
                        <div class="input-group-text" id="basic-addon3">Rp</div>
                        <input type="text" class="form-control" name="target" id="rupiah" value="<?php echo $data["target"]; ?>">
                        <input type="hidden" class="form-control" name="donasi" value="0">
                      </div>

                      <div class="form-group" style="margin-bottom: 20px;">
                        <label for="inputState" class="form-label" style="font-weight: bold;">Batas Waktu Penggalangan Dana</label>
                          <select id="inputState" name="periode" class="form-control" disabled style="cursor: not-allowed;">
                            <option selected disabled><?php echo $data["periode"]; ?></option>
                      ...
                      <div class="btn-cerita" style="text-align: center;">
                         <button type="submit" name="update" class="btn btn-update">SELESAI</button>
                       </div>
                    </form>
                  </div>
                </div>
