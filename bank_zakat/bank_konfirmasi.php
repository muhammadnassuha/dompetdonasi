...
if (isset($_POST["konfirmasi"]) ) {
    ...
    if(update_donasi_zakat($_POST) == 1 ) {
        echo "<script>
...
<head>
  ...
  <title>Dompet Donasi - Konfirmasi Donasi</title>
      ...
      <!-- Start Header -->
          <nav class="navbar navbar-expand-lg navbar-light shadow-sm" style="background-color: white;">
            <div class="container">
              ...
              <h5 class="konfirmasi-donasi" style="font-weight:bold; text-align:center;">MASUKAN NOMINAL ZAKAT ANDA</h5>
              <p  style="margin:0; text-align:center; font-size:12px; margin-bottom:10px;">Mari bantu mempermudah pengecekan data kami dan memeriksa uangnya sudah masuk atau belum kak!</p>
              ...
              <form method="post" action="" enctype="multipart/form-data" name="redirect" onsubmit="return validasi_input(this)" >
                ...
                required="required" oninvalid="this.setCustomValidity('Masukkan Nama Anda')" oninput="setCustomValidity('')">  
                      ...
                      <div class="input-group mb-3" style="margin-bottom:15px;">
                        ...
                        <input type="text" name="zakat" id="rupiah" maxlength="12" class="form-control" placeholder="Jumlah Nominal" aria-label="Username" 
                    ...
                    <div class="konfirmasi-sekarang">
                      ...
                      style="background-color: #55A746 ;width: 100%; padding: 11px; margin-bottom: 0; 
