...
$result   = mysqli_query($conn, "SELECT * FROM zakat ORDER BY id DESC LIMIT 1");
...
$subdata  = substr($data,0);
$hasil    = number_format(($subdata));
  ...
  <body>
      ...
      <div class="container"  class="shadow-sm" style="padding: 10px;margin-top: 5px;">
        ...
        <div class="konfirmasi shadow-sm" style="background-color: white; padding: 30px; border-radius: 10px;">
          ...
          <table class="table">
            <tr>
              <td style="text-align: left; font-size:12px;">Total Zakat</td>
              <th style="text-align: right; font-size:12px;"><?php echo number_format($row["total"]); ?></th>
            </tr>
          ...
          <div class="title_donasi"  style="text-align: center;">Harap ditransfer Ke Rek a/n <b><?php echo $row["nama_rek"]; ?></b> berikut ini :</div>
            <div class="rekening" style="text-align: center; margin-top: 15px">
              <img src="../img/icon/bni.png" style="float: bottom; width: 10em; margin-bottom:2px;"><p class="no_rek" style="font-size: 18px;"><b><?php echo $row["norek"]; ?></b></p>
            </div>
